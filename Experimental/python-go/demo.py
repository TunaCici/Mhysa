...
session.set_timeout(10.0)

if session.start():
    print("Cherry session started successfully!")

# Send and receive message via cherry module
message = b"Hello Cherry!"
bytes_sent = session.send(message)
...
# Disconnect using cherry module
cherry.disconnect()